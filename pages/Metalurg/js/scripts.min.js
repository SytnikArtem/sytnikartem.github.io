...
function csaHead(){i>imgHead.length-1?($(".css-head").animate({opacity:"0"},1e3,function(){i=1,$(".css-head").css({backgroundImage:"url("+imgHead[0]+")"})}),$(".css-head").animate({opacity:"1"},1e3)):($(".css-head").animate({opacity:"0"},1e3,function(){$(".css-head").css({backgroundImage:"url("+imgHead[i]+")"}),i++}),$(".css-head").animate({opacity:"1"},1e3))}$(document).ready(function(){$("#fullpage").fullpage({scrollBar:!0,fadingEffect:!0,recordHistory:!1,anchors:["main","championship","cup","futsal","history","contacts"],menu:"#myMenu",navigation:!1,navigationTooltips:["Головна","Чемпіонат","Кубок","Футзал","Історія клубу","Контакти"],showActiveTooltip:!0}),$(".footer-item").click(function(){$(".footer-item").removeClass("active"),$(this).addClass("active")}),$(window).on("hashchange",function(){var e=$(".section_second .fp-slides .active").index();$(".section_second .footer-item").removeClass("active").eq(e).addClass("active");var t=$(".section_third .fp-slides .active").index();$(".section_third .footer-item").removeClass("active").eq(t).addClass("active");var i=$(".section_fourth .fp-slides .active").index();$(".section_fourth .footer-item").removeClass("active").eq(i).addClass("active")}),$(".close-btn").click(function(){$(".close-text").text("скрити меню"),$(".menu").fadeToggle(),$(".close-text").toggleClass("active"),$(".close-text.active").text("показати меню")}),$(".bottom-block").fadeOut(),$(".top-block-btn").click(function(){$(".bottom-block").fadeToggle()}),$(".some-year").click(function(){var e=$(this).text();$(".this-year").text(e)})});var imgHead=["../img/img.jpg","../img/img1.jpg","../img/img2.jpg","../img/img3.jpg"],i=1,intervalCsaHead=setInterval(csaHead,8e3);$(window).on("load",function(){$(".holder").delay(1e3).fadeOut("slow")});