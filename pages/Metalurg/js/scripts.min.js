...
$(document).ready(function(){$("#fullpage").fullpage({scrollBar:!0,fadingEffect:!0,recordHistory:!1,anchors:["main","championship","cup","futsal","history","contacts"],menu:"#myMenu",navigation:!1,navigationTooltips:["Головна","Чемпіонат","Кубок","Футзал","Історія клубу","Контакти"],showActiveTooltip:!0}),$(".footer-item").click(function(){$(".footer-item").removeClass("active"),$(this).addClass("active")}),$(window).on("hashchange",function(){var e=$(".section_second .fp-slides .active").index();$(".section_second .footer-item").removeClass("active").eq(e).addClass("active");var t=$(".section_third .fp-slides .active").index();$(".section_third .footer-item").removeClass("active").eq(t).addClass("active");var a=$(".section_fourth .fp-slides .active").index();$(".section_fourth .footer-item").removeClass("active").eq(a).addClass("active")}),$(".close-btn").click(function(){$(".close-text").text("скрити меню"),$(".menu").fadeToggle(),$(".close-text").toggleClass("active"),$(".close-text.active").text("показати меню")}),$(".bottom-block").fadeOut(),$(".top-block-btn").click(function(){$(".bottom-block").fadeToggle()}),$(".some-year").click(function(){var e=$(this).text();$(".this-year").text(e)}),$(".btn-year").click(function(){$(".holder").fadeIn(),$(".btn-year").removeClass("current"),$(this).addClass("current");var e=$(this).index(".btn-year");setTimeout(function(){$(".this-year").removeClass("current");var t,a=$(".this-year").length;for(t=e;t<=a;t+=2)console.log(t),$(".this-year").eq(e).addClass("current"),$(".this-year").eq(t).addClass("current")},250),setTimeout(function(){$(".holder").fadeOut()},500)});var e=["../img/img.jpg","../img/img1.jpg","../img/img2.jpg","../img/img3.jpg"],t=1;setInterval(function(){t>e.length-1?($(".css-head").animate({opacity:"0"},1e3,function(){t=1,$(".css-head").css({backgroundImage:"url("+e[0]+")"})}),$(".css-head").animate({opacity:"1"},1e3)):($(".css-head").animate({opacity:"0"},1e3,function(){$(".css-head").css({backgroundImage:"url("+e[t]+")"}),t++}),$(".css-head").animate({opacity:"1"},1e3))},8e3);$("#bombardier-paginate, #bombardier-paginate2, #penalty, #penalty2").easyPaginate({slideOffset:500}),$("#calendar, #calendar2").easyPaginate({slideOffset:550,elementsPerPage:10}),$("#news, #news2").easyPaginate({slideOffset:550,elementsPerPage:3})}),$(window).on("load",function(){$(".holder").delay(1e3).fadeOut("slow")});