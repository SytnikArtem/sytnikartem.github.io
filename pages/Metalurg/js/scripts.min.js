...
$(document).ready(function(){$("#fullpage").fullpage({scrollBar:!0,fadingEffect:!0,recordHistory:!1,anchors:["main","championship","cup","futsal","history"],menu:"#myMenu",fixedElements:"#myMenu",navigation:!0,navigationTooltips:["Головна","Чемпіонат","Кубок","Футзал","Історія клубу"],showActiveTooltip:!0,slidesNavigation:!0})});