...
$(document).ready(function(){$("#fullpage").fullpage({scrollBar:!0,fadingEffect:!0,recordHistory:!1,anchors:["main","championship","cup","futsal","history","contacts"],menu:"#myMenu",navigation:!0,navigationTooltips:["Головна","Чемпіонат","Кубок","Футзал","Історія клубу","Контакти"],showActiveTooltip:!0}),$(".footer-item").click(function(){$(".footer-item").removeClass("active"),$(this).addClass("active")}),$(window).on("hashchange",function(){var e=$(".section_second .fp-slides .active").index();$(".footer-item").removeClass("active").eq(e).addClass("active")})});