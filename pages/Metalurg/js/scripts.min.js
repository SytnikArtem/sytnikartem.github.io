...
$.fn.easyPaginate = function (options) {
    var defaults = {
        ...
        slideOffset: 2000,
        firstButton: true,
        firstButtonText: 'початок',
        lastButton: true,
        lastButtonText: 'кінець',
        prevButton: true,
...
$(document).ready(function(){$(window).width()>1200&&($("#fullpage").fullpage({scrollBar:!0,fadingEffect:!0,recordHistory:!1,anchors:["main","championship","cup","futsal","history","contacts"],menu:"#myMenu",navigation:!1,navigationTooltips:["Головна","Чемпіонат","Кубок","Футзал","Історія клубу","Контакти"],showActiveTooltip:!0}),$("#news, #news-clone-cmemp2018, #news-clone-futzal2018, #news-clone-cup2018").easyPaginate({slideOffset:400,elementsPerPage:3})),$(".owl-carousel").owlCarousel({items:1,nav:!0,dots:!0,navText:["<",">"]}),$(".footer-item").click(function(){$(".footer-item").removeClass("active"),$(this).addClass("active")}),$(window).on("hashchange",function(){var e=$(".section_second .fp-slides .active").index();$(".section_second .footer-item").removeClass("active").eq(e).addClass("active");var a=$(".section_third .fp-slides .active").index();$(".section_third .footer-item").removeClass("active").eq(a).addClass("active");var t=$(".section_fourth .fp-slides .active").index();$(".section_fourth .footer-item").removeClass("active").eq(t).addClass("active")}),$(".close").click(function(){$(".close-text").text("скрити меню"),$(".menu, .footer").fadeToggle(),$(".close-text").toggleClass("active"),$(".close-text.active").text("показати меню")}),$(".btn-year").click(function(){$(".holder").fadeIn(),$(".btn-year").removeClass("current");var e=$(this).index(".btn-year")%2;setTimeout(function(){$(".this-year").removeClass("current");var a,t=$(".this-year").length;for(a=e;a<=t;a+=2)console.log(a),$(".this-year").eq(a).addClass("current"),$(".btn-year").eq(a).addClass("current")},250),setTimeout(function(){$(".holder").fadeOut()},500)});var e=["../Metalurg/img/img.jpg","../Metalurg/img/img1.jpg","../Metalurg/img/img2.jpg","../Metalurg/img/img3.jpg"],a=1;setInterval(function(){a>e.length-1?($(".css-head").animate({opacity:"0"},1e3,function(){a=1,$(".css-head").css({backgroundImage:"url("+e[0]+")"})}),$(".css-head").animate({opacity:"1"},1e3)):($(".css-head").animate({opacity:"0"},1e3,function(){$(".css-head").css({backgroundImage:"url("+e[a]+")"}),a++}),$(".css-head").animate({opacity:"1"},1e3))},8e3);$("#bombardier-paginate, #bombardier-paginate2, #bombardier-paginate3, #bombardier-paginate4, #penalty, #penalty2, #penalty3, #penalty4").easyPaginate({slideOffset:400,elementsPerPage:10}),$("#calendar, #calendar2, #calendar3, #calendar4").easyPaginate({slideOffset:400,elementsPerPage:10}),$(window).width()<1200&&$("#news, #news-clone-cmemp2018, #news-clone-futzal2018, #news-clone-cup2018").easyPaginate({slideOffset:400,elementsPerPage:2})});var linkPage=$(".section-first .news-item").find("a");for(i=0;i<linkPage.length;i++){var autoLink="/pages/page"+(linkPage.length-i)+".html";linkPage.eq(i).attr("href",autoLink)}console.log(linkPage),$(".news-item.chemp-clone").clone().appendTo("#news-clone-cmemp2018"),$(".news-item.futzal-clone").clone().appendTo("#news-clone-futzal2018"),$(".news-item.cup-clone").clone().appendTo("#news-clone-cup2018"),$(".news-btn, .news-close").click(function(){$(".news-main .main-block-news").toggleClass("slide"),$(".news-main .main-block-next-match").removeClass("slide"),$(".next-match-btn").removeClass("slide"),$(".news-btn").toggleClass("slide")}),$(".next-match-btn, .next-match-close").click(function(){$(".news-main .main-block-next-match").toggleClass("slide"),$(".news-main .main-block-news").removeClass("slide"),$(".next-match-btn").toggleClass("slide"),$(".news-btn").removeClass("slide")}),$(document).on("click",".scrollto",function(e){e.preventDefault(),$("html, body").animate({scrollTop:$($.attr(this,"href")).offset().top},500)}),$(window).on("load",function(){$(".holder").delay(1e3).fadeOut("slow")});