$(document).ready(function(){
    ...
    var counrtiesPath = 'https://github.com/SytnikArtem/sytnikartem.github.io/blob/master/pages/json/' + 'countries.json';

    function createMap(){
        $.getJSON(counrtiesPath, function(country) {
            ...
            let countryCodeValue = 'https://github.com/SytnikArtem/sytnikartem.github.io/blob/master/pages/json/' + countryCode.toLocaleLowerCase()+'.json';
