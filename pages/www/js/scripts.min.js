    ...
    $.fn.easyPaginate = function(options) {
        ...
        return this.each(function(instance) {
            ...
            var displayNav = function() {
                ...
                $(elSelector + ' .easyPaginateNav a.page,' + elSelector + ' .easyPaginateNav a.first,' + elSelector + ' .easyPaginateNav a.last').on('click', function(e) {
                    e.preventDefault();
...
$(document).ready(function() {
    if ($(window).width() > 1200) {
        $("#fullpage").fullpage({
            ...
            fadingEffect: !0,
            recordHistory: !1,
            anchors: ["main", "championship", "cup", "futsal", "history", "contacts"],
            menu: "#myMenu",
            navigation: !1,
            navigationTooltips: ["Головна", "Чемпіонат", "Кубок", "Футзал", "Історія клубу", "Контакти"],
            showActiveTooltip: !0
        }), $("#news, #news-clone-cmemp2018, #news-clone-futzal2018, #news-clone-cup2018").easyPaginate({
            slideOffset: 400,
            elementsPerPage: 3
        });
        var e = ["../img/img4.jpg", "../img/img.jpg", "../img/img1.jpg", "../img/img2.jpg"],
            a = 1;
        setInterval(function() {
            a > e.length - 1 ? ($(".css-head").animate({
                opacity: "0"
            }, 500, function() {
                a = 1, $(".css-head").css({
    ...
    $(window).width() <= 1200 && $(".news-main .main-block-news").addClass("slide"), $(".owl-carousel").owlCarousel({
        items: 1,
        nav: !0,
        dots: !0,
        navText: ["<", ">"]
    ...
    //     $(".footer-item").removeClass("active"), $(this).addClass("active")
    // }),
    $(window).on("hashchange", function() {
        var e = $(".section_second .fp-slides .active").index();
        $(".section_second .footer-item").removeClass("active").eq(e).addClass("active");
        var a = $(".section_third .fp-slides .active").index();
        $(".section_third .footer-item").removeClass("active").eq(a).addClass("active");
        var n = $(".section_fourth .fp-slides .active").index();
        $(".section_fourth .footer-item").removeClass("active").eq(n).addClass("active")
    }), $(".close").click(function() {
        $(".close-text").text("скрити меню"), $(".menu-desctop, .footer").fadeToggle(), $(".close-text").toggleClass("active"), $(".close-text.active").text("показати меню")
    }), $("#bombardier-paginate, #bombardier-paginate2, #bombardier-paginate31, #bombardier-paginate32, #bombardier-paginate4, #penalty, #penalty2, #penalty3, #penalty4, #calendar5").easyPaginate({
        slideOffset: 400,
        elementsPerPage: 10
    }), $("#calendar, #calendar2, #calendar4, #calendar32").easyPaginate({
        slideOffset: 400,
        elementsPerPage: 7
    }), $("#calendar31").easyPaginate({
        slideOffset: 400,
        elementsPerPage: 6
    }),$(window).width() < 1200 && $("#news, #news-clone-cmemp2018, #news-clone-futzal2018, #news-clone-cup2018").easyPaginate({
        slideOffset: 400,
        elementsPerPage: 2
    })
});
var linkPage = $(".section-first .news-item").find("a");
for (i = 0; i < linkPage.length; i++) {
    var autoLink = "/pages/page" + (linkPage.length - i) + ".html";
    linkPage.eq(i).attr("href", autoLink)
}
$('.btn-change_liga').click(function(){
		$(".holder").fadeIn();
		$('.btn-change_liga').removeClass('current');
		var liga = 2;
		var indexBtn = $(this).index('.btn-change_liga') % liga;
		setTimeout(function(){
				$('.this-liga').removeClass('current');
				var i;
				var yearLength = $('.this-year').length;
				for (i = indexBtn; i <= yearLength; i += liga) {
					$('.this-liga').eq(i).addClass('current');
					$('.btn-change_liga').eq(i).addClass('current');
				};
		}, 250);
		setTimeout(function(){
			$(".holder").fadeOut()
...
$(".news-item.chemp-clone").clone().appendTo("#news-clone-cmemp2018"), $(".news-item.futzal-clone").clone().appendTo("#news-clone-futzal2018"), $(".news-item.cup-clone").clone().appendTo("#news-clone-cup2018"), $(".news-btn, .news-close").click(function() {
    $(".news-main .main-block-news").toggleClass("slide"), $(".news-main .main-block-next-match").removeClass("slide"), $(".next-match-btn").removeClass("slide"), $(".news-btn").toggleClass("slide")
}), $(".next-match-btn, .next-match-close").click(function() {
    $(".news-main .main-block-next-match").toggleClass("slide"), $(".news-main .main-block-news").removeClass("slide"), $(".next-match-btn").toggleClass("slide"), $(".news-btn").removeClass("slide")
}), $(document).on("click", ".scrollto", function(e) {
    e.preventDefault(), $("html, body").animate({
        scrollTop: $($.attr(this, "href")).offset().top
    }, 500)
}), $(window).on("load", function() {
    $(".holder").delay(1e3).fadeOut("slow")
});
